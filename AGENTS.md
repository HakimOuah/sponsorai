...
- **API IA** : Anthropic Codex API (Codex-sonnet-4-20250514) avec web search
...
- **Agents disponibles** :
  1. **Scout** : recherche de marques (web search + Codex)
...
### Agent Scout
- **Input** : profil joueur
- **Process** : 2 appels Codex — (1) web search en texte libre, (2) structuration JSON
...
- **Process** : 1 appel Codex — scoring sur 6 critères
...
- **Process** : 1 appel Codex — génération mail personnalisé
