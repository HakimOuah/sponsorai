    ...
    <div className="space-y-4">
      <div>
        ...
        <input
          ...
          className="w-full max-w-sm rounded-lg border border-white/[0.08] bg-white/[0.03] px-4 py-2.5 text-sm text-white placeholder-white/20 focus:border-[#00d4aa]/30 focus:outline-none"
        />
      </div>
      ...
      {message && <p className="text-sm text-[#00d4aa]">{message}</p>}
