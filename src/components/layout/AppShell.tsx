    ...
    <AgentExperienceProvider>
      ...
      <div className="app-workspace relative flex min-h-screen overflow-x-hidden bg-[#0B0D12] text-[#F6F4EF]">
        ...
        >
          ...
          />
          {isReadOnly ? (
            <div className="mx-4 mt-4 rounded-2xl border border-[#C8CEFF]/20 bg-[#C8CEFF]/[0.07] px-4 py-3 text-xs leading-relaxed text-[#D9DDFF] sm:mx-6 lg:mx-8">
              Mode découverte : vous pouvez consulter l’ensemble de l’outil. Les
              agents et les modifications sont réservés aux comptes Client et
              Administrateur.
            </div>
          ) : null}
