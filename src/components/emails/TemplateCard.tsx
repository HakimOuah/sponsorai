    ...
    <div className="rounded-xl border border-white/[0.06] bg-[#0c1019] overflow-hidden">
      <div className="flex items-center gap-3 p-4">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <h3
              className="font-semibold text-white truncate cursor-pointer hover:text-[#00d4aa] transition-colors"
          ...
          <p className="text-xs text-white/40 truncate mt-0.5">{template.subject}</p>
        </div>
        ...
        <button
          ...
          className={`shrink-0 transition-colors ${
            deleteConfirm ? "text-red-400" : "text-white/30 hover:text-red-400"
          }`}
        >
      ...
      {expanded && (
        <div className="border-t border-white/[0.06] px-4 pb-4 pt-3">
          ...
          <div className="rounded-lg bg-white/[0.03] p-3 text-sm text-white/60 whitespace-pre-wrap leading-relaxed">
            {template.body}
          </div>
